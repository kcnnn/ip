...
(async()=>{
 ...
 try {
  ...
  await page.locator('[name=details]').fill('Equipment label');await page.locator('#fieldEquipmentResearch summary').click();
  ...
  await page.locator('[name=details]').fill('Equipment label at rear wall.');await page.locator('#fieldEditDetails summary').click();await page.locator('[name=location]').fill('Rear wall');
  ...
  await page.locator('#fieldEquipmentResearch summary').click();
